<template>
  <div class="ResourcesUse">
    <!-- 资源使用界面 -->
    <el-card class="box-card" v-for="i in Resources_msg">
      ...
      <div style="float: left; width: 55%; height: 300px">
        ...
        <div class="stepbox">
          <p>流程</p>
          <el-steps :active="i.how" finish-status="success">
...
<style>
@import url("./../../../../scss/UpResources/ResourcesUse.css");
</style>
